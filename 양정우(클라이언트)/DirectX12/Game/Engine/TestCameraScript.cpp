						...
						if (pickedObject != NULL)
						{
							...
							if (pickedObject->GetTransform()->GetObjectType() == OT_PLAYER)
							{
								...
								if (range <= gunRange)
								{
									...
									float 맞은놈_X, 맞은놈_Y, 맞은놈_Z;

									맞은놈_X = pickedObject->GetTransform()->GetLocalPosition().x;
									맞은놈_Y = pickedObject->GetTransform()->GetLocalPosition().y;
									맞은놈_Z = pickedObject->GetTransform()->GetLocalPosition().z;
