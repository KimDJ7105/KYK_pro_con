...
D3D12_SHADER_BYTECODE CShader::CompileShaderFromFile(const wstring& pszFileName, LPCSTR pszShaderName, LPCSTR pszShaderProfile, ID3DBlob** ppd3dShaderBlob)
{
	...
	HRESULT hResult = ::D3DCompileFromFile(pszFileName.c_str(), NULL, D3D_COMPILE_STANDARD_FILE_INCLUDE, pszShaderName, pszShaderProfile, nCompileFlags, 0, ppd3dShaderBlob, &pd3dErrorBlob);
