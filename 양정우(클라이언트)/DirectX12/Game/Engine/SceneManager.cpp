...
#pragma region FBX Player
	{
		...
		//shared_ptr<MeshData> meshData2 = GET_SINGLE(Resources)->LoadBinaryModel(L"..\\Resources\\FBX\\Player\\Player(No animation).bin");
...
#pragma endregion
	...
	
	{
		...
		//shared_ptr<MeshData> meshData = GET_SINGLE(Resources)->LoadBinaryModel(L"..\\Resources\\FBX\\Map\\Gate\\Gate001.fbx");
